...
import 'package:isletestapp/view/screens/test.dart';
...
class PlaceOrderTrack extends StatefulWidget {
  final String orderNumber;
  const PlaceOrderTrack({Key? key, required this.orderNumber}) : super(key: key);
  @override
  State<PlaceOrderTrack> createState() => _WardrobNameState();
}

class _WardrobNameState extends State<PlaceOrderTrack> {

  void initState() {
    // TODO: implement initState
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      Get.find<OrderTrackController>().getOrderTrackData(id: widget.orderNumber);
    }
    );
  }
                                              ...
                                              Column(
                                                children: [
                                                  controller.orderTrackresponse != null
                                                      ...
                                                      ? CircleAvatar(
                                                    backgroundColor: controller.orderTrackresponse!.data![index].packageStatus == "pending" ?
                                                    gold
                                                        : silvercolor,
                                                    radius: 30,
                                              ...
                                              Column(
                                                children: [
                                                  controller.orderTrackresponse != null
                                                      ...
                                                      controller.orderTrackresponse!.data!.length > 0
                                                      ? CircleAvatar(
                                                    backgroundColor: controller.orderTrackresponse!.data![index].packageStatus == "confirmed"
                                                        ? gold
                                                        : silvercolor,
                                                    radius: 30,
