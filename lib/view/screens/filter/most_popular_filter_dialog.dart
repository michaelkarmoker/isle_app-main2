...
import '../../../data/model/response/filter/most_popular_product_filter_term.dart';

class MostPupularFilterPageDialog extends StatefulWidget {
  final MostPopularFilterTermModel? filterModel;
  final String? id;
  // final int? pageId;

  const MostPupularFilterPageDialog({
    super.key,
  ...
  @override
  State<MostPupularFilterPageDialog> createState() => _MostPupularFilterPageDialogState();
}

class _MostPupularFilterPageDialogState extends State<MostPupularFilterPageDialog> {
                        ...
                        children: [
                          ...
                          Expanded(
                              child: ElevatedButton(
                                onPressed: () {
                                  // savePrice();
                                  productController.getMostPopularProductData(
...
class SectionSizeTypesRightSiteWidget extends StatefulWidget {
  final List<MostPopularFilterTermSizes> sizedModel;
...
class SectionBrandRightSiteWidget extends StatefulWidget {
  final List<MostPopularFilterTermBrands> brandModel;
  final Function onSizeSelected;
...
class SectionColorRightSiteWidget extends StatefulWidget {
  final List<MostPopularFilterTermColors> colorModel;
  final Function onSizeSelected;
...
class SectionDiscountRightSiteWidget extends StatefulWidget {
  final CategoryProductDiscount? discountModel;
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '(${widget.discountModel?.discount10 ?? 0} Item)',
                      style: const TextStyle(
                        fontSize: 13,
                        color: Colors.grey,
                      ),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '(${widget.discountModel?.discount20 ?? 0} Item)',
                      style: const TextStyle(
                        fontSize: 13,
                        color: Colors.grey,
                      ),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '(${widget.discountModel?.discount30 ?? 0} Item)',
                      style: const TextStyle(
                        fontSize: 13,
                        color: Colors.grey,
                      ),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '(${widget.discountModel?.discount40 ?? 0} Item)',
                      style: const TextStyle(
                        fontSize: 13,
                        color: Colors.grey,
                      ),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '(${widget.discountModel?.discount50 ?? 0} Item)',
                      style: const TextStyle(
                        fontSize: 13,
                        color: Colors.grey,
                      ),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '(${widget.discountModel?.discount60 ?? 0} Item)',
                      style: const TextStyle(
                        fontSize: 13,
                        color: Colors.grey,
                      ),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '(${widget.discountModel?.discount70 ?? 0} Item)',
                      style: const TextStyle(
                        fontSize: 13,
                        color: Colors.grey,
                      ),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '(${widget.discountModel?.discount80 ?? 0} Item)',
                      style: const TextStyle(
                        fontSize: 13,
                        color: Colors.grey,
                      ),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '(${widget.discountModel?.discount90 ?? 0} Item)',
                      style: const TextStyle(
                        fontSize: 13,
                        color: Colors.grey,
                      ),
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      '(${widget.discountModel?.discount100 ?? 0} Item)',
                      style: const TextStyle(
                        fontSize: 13,
                        color: Colors.grey,
                      ),
