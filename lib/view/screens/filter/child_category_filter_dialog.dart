...
class ChildCategoryFilterPageDialog extends StatefulWidget {
  final ChildCategoryProductFilterModel? filterModel;
  final String? id;
  final int? pageId;
  final String? title;

  const ChildCategoryFilterPageDialog({
    super.key,
  ...
  @override
  State<ChildCategoryFilterPageDialog> createState() => _FilterPageScreenState();
}

class _FilterPageScreenState extends State<ChildCategoryFilterPageDialog> {
                        ...
                        children: [
                          ...
                          Expanded(
                              child: ElevatedButton(
                                onPressed: () {
                                  // savePrice();
                                  productController.getChildCategoryProductData(
                                      childCategoryId: widget.id ?? selectSection.toString(),
...
class ChildCategorySectionRightSiteWidget extends StatefulWidget {
  final List<ChildCategoryProductFilterCategories> sections;
  final Function onSectionSelected;

  const ChildCategorySectionRightSiteWidget({
    super.key,
  ...
  @override
  State<ChildCategorySectionRightSiteWidget> createState() => _ChildCategorySectionRightSiteWidgetState();
}

class _ChildCategorySectionRightSiteWidgetState extends State<ChildCategorySectionRightSiteWidget> {
...
class ChildCategorySizeTypesRightSiteWidget extends StatefulWidget {
  final List<ChildCategoryProductFilterSizesModel> sizedModel;
  final Function onSizeSelected;


  const ChildCategorySizeTypesRightSiteWidget({
    Key? key,
  ...
  @override
  State<ChildCategorySizeTypesRightSiteWidget> createState() =>
      _ChildCategorySizeTypesRightSiteWidgetState();
}

class _ChildCategorySizeTypesRightSiteWidgetState extends State<ChildCategorySizeTypesRightSiteWidget> {
...
class ChildCategoryBrandRightSiteWidget extends StatefulWidget {
  final List<ChildCategoryProductFilterBrands> brandModel;
  final Function onSizeSelected;
  const ChildCategoryBrandRightSiteWidget({
    super.key,
  ...
  @override
  State<ChildCategoryBrandRightSiteWidget> createState() => _ChildCategoryBrandRightSiteWidgetState();
}

class _ChildCategoryBrandRightSiteWidgetState extends State<ChildCategoryBrandRightSiteWidget> {
...
class ChildCategoryColorRightSiteWidget extends StatefulWidget {
  final List<ChildCategoryProductFilterColors> colorModel;
  final Function onSizeSelected;

  const ChildCategoryColorRightSiteWidget({
    super.key,
  ...
  @override
  State<ChildCategoryColorRightSiteWidget> createState() => _ChildCategoryColorRightSiteWidgetState();
}

class _ChildCategoryColorRightSiteWidgetState extends State<ChildCategoryColorRightSiteWidget> {
...
class ChildCategoryDiscountRightSiteWidget extends StatefulWidget {
  final ChildCategoryProductFilterDiscount? discountModel;
  final Function(int) onDiscountSelected;

  const ChildCategoryDiscountRightSiteWidget({
    super.key,
  ...
  @override
  State<ChildCategoryDiscountRightSiteWidget> createState() =>
      _ChildCategoryDiscountRightSiteWidgetState();
}

class _ChildCategoryDiscountRightSiteWidgetState
    extends State<ChildCategoryDiscountRightSiteWidget> {
  int? selectedDiscount;
