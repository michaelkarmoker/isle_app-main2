...
import 'package:isletestapp/data/model/response/filter/sell_product_filter_term_model.dart';
...
class SellSectionFilterPageDialog extends StatefulWidget {
  final SellProductFilterTermModel? filterModel;
  final String? id;
  final int? pageId;
  ...
  const SellSectionFilterPageDialog({
    super.key,
  ...
  @override
  State<SellSectionFilterPageDialog> createState() => _FilterPageScreenState();
}

class _FilterPageScreenState extends State<SellSectionFilterPageDialog> {
                        ...
                        children: [
                          ...
                          Expanded(
                              child: ElevatedButton(
                                onPressed: () {
                                  // savePrice();
                                  productController.getSellProductData(
                                      ...
                                      discount: selectedDiscount == null ? widget.discountText : selectedDiscount.toString(),
...
class SellSectionRightSiteWidget extends StatefulWidget {
  final List<SellProductFilterTermCategories> sections;
  final Function onSectionSelected;

  const SellSectionRightSiteWidget({
    super.key,
  ...
  @override
  State<SellSectionRightSiteWidget> createState() => _SellSectionRightSiteWidgetState();
}

class _SellSectionRightSiteWidgetState extends State<SellSectionRightSiteWidget> {
...
class SellSectionSizeTypesRightSiteWidget extends StatefulWidget {
  final List<SellProductFilterTermSizesModel> sizedModel;
  final Function onSizeSelected;


  const SellSectionSizeTypesRightSiteWidget({
    Key? key,
  ...
  @override
  State<SellSectionSizeTypesRightSiteWidget> createState() =>
      _SellSectionSizeTypesRightSiteWidgetState();
}

class _SellSectionSizeTypesRightSiteWidgetState extends State<SellSectionSizeTypesRightSiteWidget> {
...
class SellSectionBrandRightSiteWidget extends StatefulWidget {
  final List<SellProductFilterTermBrands> brandModel;
  final Function onSizeSelected;
  const SellSectionBrandRightSiteWidget({
    super.key,
  ...
  @override
  State<SellSectionBrandRightSiteWidget> createState() => _SellSectionBrandRightSiteWidgetState();
}

class _SellSectionBrandRightSiteWidgetState extends State<SellSectionBrandRightSiteWidget> {
...
class SellSectionColorRightSiteWidget extends StatefulWidget {
  final List<SellProductFilterTermColors> colorModel;
  final Function onSizeSelected;

  const SellSectionColorRightSiteWidget({
    super.key,
  ...
  @override
  State<SellSectionColorRightSiteWidget> createState() => _SellSectionColorRightSiteWidgetState();
}

class _SellSectionColorRightSiteWidgetState extends State<SellSectionColorRightSiteWidget> {
...
class SellSectionPriceRightSiteWidget extends StatefulWidget {
  ...
  @override
  State<SellSectionPriceRightSiteWidget> createState() => _SellSectionPriceRightSiteWidgetState();
}

class _SellSectionPriceRightSiteWidgetState extends State<SellSectionPriceRightSiteWidget> {
...
class SellSectionDiscountRightSiteWidget extends StatefulWidget {
  final SellProductFilterTermDiscount? discountModel;
  final Function(int) onDiscountSelected;

  const SellSectionDiscountRightSiteWidget({
    super.key,
  ...
  @override
  State<SellSectionDiscountRightSiteWidget> createState() =>
      _SellSectionDiscountRightSiteWidgetState();
}

class _SellSectionDiscountRightSiteWidgetState
    extends State<SellSectionDiscountRightSiteWidget> {
  int? selectedDiscount;
