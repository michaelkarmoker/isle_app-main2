...
class CategoryFilterPageDialog extends StatefulWidget {
  final CategoryProductFilterTermModel? filterModel;
  final String? id;
  final String? title;
  // final int? pageId;

  const CategoryFilterPageDialog({
    super.key,
  ...
  @override
  State<CategoryFilterPageDialog> createState() => _FilterPageScreenState();
}

class _FilterPageScreenState extends State<CategoryFilterPageDialog> {
                        ...
                        children: [
                          ...
                          Expanded(
                              child: ElevatedButton(
                                onPressed: () {
                                  // savePrice();
                                  productController.getCategoryProductData(
                                      categoryId: widget.id ?? selectSection.toString(),
...
class SectionSizeTypesRightSiteWidget extends StatefulWidget {
  final List<CategoryProductSizesModel> sizedModel;
...
class SectionBrandRightSiteWidget extends StatefulWidget {
  final List<CategoryProductBrands> brandModel;
  final Function onSizeSelected;
...
class SectionColorRightSiteWidget extends StatefulWidget {
  final List<CategoryProductColors> colorModel;
  final Function onSizeSelected;
