...
import 'package:isletestapp/data/model/response/filter/section_newin_filter_model.dart';
...
class SectionNewInFilterPageDialog extends StatefulWidget {
  final SectionNewInProductFilterModel? filterModel;
  final String? id;
  final int? pageId;
  final String? title;

  const SectionNewInFilterPageDialog({
    super.key,
  ...
  @override
  State<SectionNewInFilterPageDialog> createState() => _FilterPageScreenState();
}

class _FilterPageScreenState extends State<SectionNewInFilterPageDialog> {
                        ...
                        children: [
                          ...
                          Expanded(
                              child: ElevatedButton(
                                onPressed: () {
                                  // savePrice();
                                  productController.getSectionNewInData(
...
class SectionNewInRightSiteWidget extends StatefulWidget {
  final List<SectionNewInSections> sections;
...
class SectionNewInSizeTypesRightSiteWidget extends StatefulWidget {
  final List<SectionNewInSizesModel> sizedModel;
  final Function onSizeSelected;


  const SectionNewInSizeTypesRightSiteWidget({
    Key? key,
  ...
  @override
  State<SectionNewInSizeTypesRightSiteWidget> createState() =>
      _SectionNewInSizeTypesRightSiteWidgetState();
}

class _SectionNewInSizeTypesRightSiteWidgetState extends State<SectionNewInSizeTypesRightSiteWidget> {
...
class SectionNewInBrandRightSiteWidget extends StatefulWidget {
  final List<SectionNewInBrands> brandModel;
  final Function onSizeSelected;
  const SectionNewInBrandRightSiteWidget({
    super.key,
  ...
  @override
  State<SectionNewInBrandRightSiteWidget> createState() => _SectionNewInBrandRightSiteWidgetState();
}

class _SectionNewInBrandRightSiteWidgetState extends State<SectionNewInBrandRightSiteWidget> {
...
class SectionNewInColorRightSiteWidget extends StatefulWidget {
  final List<SectionNewInColors> colorModel;
  final Function onSizeSelected;

  const SectionNewInColorRightSiteWidget({
    super.key,
  ...
  @override
  State<SectionNewInColorRightSiteWidget> createState() => _SectionNewInColorRightSiteWidgetState();
}

class _SectionNewInColorRightSiteWidgetState extends State<SectionNewInColorRightSiteWidget> {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const SizedBox(width: 5),
                      Text('(${widget.colorModel[colorIndex]?.productCount.toString() ?? 0})',
                          style: const TextStyle(
                              fontSize: 13,
                              color: Colors.grey
                          )
...
class SectionNewInPriceRightSiteWidget extends StatefulWidget {
  ...
  @override
  State<SectionNewInPriceRightSiteWidget> createState() => _SectionNewInPriceRightSiteWidgetState();
}

class _SectionNewInPriceRightSiteWidgetState extends State<SectionNewInPriceRightSiteWidget> {
...
class SectionNewInDiscountRightSiteWidget extends StatefulWidget {
  final SectionNewInDiscount? discountModel;
  final Function(int) onDiscountSelected;

  const SectionNewInDiscountRightSiteWidget({
    super.key,
  ...
  @override
  State<SectionNewInDiscountRightSiteWidget> createState() =>
      _SectionDiscountRightSiteWidgetState();
}

class _SectionDiscountRightSiteWidgetState extends State<SectionNewInDiscountRightSiteWidget> {
  int? selectedDiscount;
