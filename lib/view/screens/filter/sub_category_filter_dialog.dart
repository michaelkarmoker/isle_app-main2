...
class SubCategoryFilterPageDialog extends StatefulWidget {
  final SubCategoryProductFilterModel? filterModel;
  final String? id;
  final int? pageId;
  final String? title;

  const SubCategoryFilterPageDialog({
    super.key,
  ...
  @override
  State<SubCategoryFilterPageDialog> createState() => _FilterPageScreenState();
}

class _FilterPageScreenState extends State<SubCategoryFilterPageDialog> {
                        ...
                        children: [
                          ...
                          Expanded(
                              child: ElevatedButton(
                                onPressed: () {
                                  // savePrice();
                                  productController.getSubCategoryProductData(
                                      subCategoryId: widget.id ?? selectSection.toString(),
...
class SectionSectionRightSiteWidget extends StatefulWidget {
  final List<SubCategoryProductCategories> sections;
...
class SectionSizeTypesRightSiteWidget extends StatefulWidget {
  final List<SubCategoryProductSizesModel> sizedModel;
...
class SectionBrandRightSiteWidget extends StatefulWidget {
  final List<SubCategoryProductBrands> brandModel;
  final Function onSizeSelected;
...
class SectionColorRightSiteWidget extends StatefulWidget {
  final List<SubCategoryProductColors> colorModel;
  final Function onSizeSelected;
...
class SectionDiscountRightSiteWidget extends StatefulWidget {
  final SubCategoryProductDiscount? discountModel;
