...
import 'package:isletestapp/data/model/response/filter/brand_type_product_filter_term_model.dart';
...
class BrandTypeFilterPageDialog extends StatefulWidget {
  final BrandTypeProductFilterModel? filterModel;
  final String? id;
  final int? pageId;

  const BrandTypeFilterPageDialog({
    super.key,
  ...
  @override
  State<BrandTypeFilterPageDialog> createState() => _FilterPageScreenState();
}

class _FilterPageScreenState extends State<BrandTypeFilterPageDialog> {
                        ...
                        children: [
                          ...
                          Expanded(
                              child: ElevatedButton(
                                onPressed: () {
                                  // savePrice();
                                  productController.getBrandTypeProductData(
...
class SectionSectionRightSiteWidget extends StatefulWidget {
  final List<BrandTypeProductFilterAllBrands> sections;
...
class SectionSizeTypesRightSiteWidget extends StatefulWidget {
  final List<BrandTypeProductFilterSizes> sizedModel;
...
class SectionColorRightSiteWidget extends StatefulWidget {
  final List<BrandTypeProductFilterColors> colorModel;
  final Function onSizeSelected;
